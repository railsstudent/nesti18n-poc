...
export class AllExceptionsFilter implements ExceptionFilter {
	...
	private isTranlsatedErrorException(errorResponse: object): errorResponse is { key: string, args?: Record<string, any> } {
	...
	private async createResponseBody(ctx: HttpArgumentsHost, statusCode: number, errorResponse: object): Promise<{ statusCode: number, message: string, error: string } | undefined> {
